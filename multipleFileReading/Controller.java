package com.tutorial.Programs.multipleFileReading;
	...
	private static void createAndStartProducers() {
		for (int i = 1; i <= NUMBER_OF_PRODUCERS; i++) {/*
			...
			Producer producer = new Producer(
					Paths.get("C:\\Hema\\Study\\wks\\InterviewQ\\src\\com\\tutorial\\Programs\\multipleFileReading\\files\\file" + i + ".txt"), queue);
